---
title: "Qwen-Image & Qwen-Image-Edit in ComfyUI"
...
**Qwen-Image is Apache 2.0** — commercial use included, no revenue threshold, no
separate agreement. The
[Comfy-Org/Qwen-Image_ComfyUI](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI)
repackage the pack downloads declares `apache-2.0`.

That applies to Qwen-Image-Edit as well. Both are safe to build products on, which is
a meaningful part of why the Qwen image line got adopted so quickly.

The LoRAs and upscalers the packs pull are separate projects under their own terms.
...
| Tier | VRAM | Notes |
|------|------|-------|
| **Q4_K_S** | **under 12 GB** | Recommended default; the manifest ships this tier active |
...
**How much VRAM do I need?** Roughly **under 12 GB** for the Q4_K_S tier, **12–24 GB**
