---
title: "How to Run Ideogram 4 Locally in ComfyUI"
...
**Ideogram 4 is open-weight but NOT open-source, and commercial use is not permitted
without a separate license.** The model card declares
`ideogram-non-commercial-model-agreement` — read that name literally.

You can download the weights, run them locally, and experiment freely. You cannot
ship the output in a commercial product, sell generations, or host it behind a paid
service on these terms. Ideogram sells commercial licensing separately.

This is the sharpest licensing difference in the model-highlight series. If your work
is commercial and you want comparable text and layout quality, look at
[ERNIE-Image](./ernie-image-comfyui) (Apache 2.0) or
[Z-Image](./z-image-comfyui) (Apache 2.0) instead — both permit it outright.
